/*! cornerstone-core - 2.2.8 - 2018-12-28 | (c) 2016 Chris Hafey | https://github.com/cornerstonejs/cornerstone */
...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "6b9c32cc3ec93acbb6be";
...
function rescaleImage(baseLayer, targetLayer) {
  ...
  if (targetLayer.options) {
    if (targetLayer.options.preScaled) {
      var _colRelative = targetImage.width / baseImage.width;

      var _viewportRatio = targetLayer.viewport.scale / baseLayer.viewport.scale * _colRelative;

      targetLayer.viewport.scale = baseLayer.viewport.scale * _viewportRatio;
      return;
    }
  }
